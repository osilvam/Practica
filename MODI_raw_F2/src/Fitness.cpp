...
void Fitness::measuringValues(vector < double > position, double rightVel, double leftVel, bool collision)
{
	double aux1;
...
{
    if(stdDesviation(robot_rightVel) < 2 && stdDesviation(robot_leftVel) < 2)
    {
